          ...
          >
            <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/5">
              <h2 className="text-lg font-black text-gray-900 dark:text-white flex items-center gap-2">
                <span className="text-xl">👋</span> قائمة الخيارات
              </h2>
              <button
                onClick={onClose}
                 ...
                 <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                       ...
                       {appSettings.social_snapchat && (
                         <a href={appSettings.social_snapchat} target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-zinc-800 rounded-xl hover:bg-primary/10 hover:text-primary transition-colors text-gray-500 dark:text-gray-300 flex items-center justify-center font-bold text-lg leading-none w-[40px] h-[40px]">
                           👻
                         </a>
                       )}
                       {appSettings.social_tiktok && (
                         <a href={appSettings.social_tiktok} target="_blank" rel="noopener noreferrer" className="bg-gray-100 dark:bg-zinc-800 rounded-xl hover:bg-primary/10 hover:text-primary transition-colors text-gray-500 dark:text-gray-300 flex items-center justify-center font-bold text-lg leading-none w-[40px] h-[40px]">
                           🎵
                         </a>
                       )}
                    </div>
            ...
            <div className="p-4 border-t border-gray-100 dark:border-white/5 text-center bg-gray-50/50 dark:bg-transparent">
              <p className="text-[10px] text-gray-400 font-medium tracking-wide">جمر التنور © 2024</p>
            </div>
          </motion.div>
        </>
      )}
